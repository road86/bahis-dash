...
def layout_gen(aid=None, **other_unknown_query_strings):
    ...
    return html.Div(
        [
            ...
            html.H2("Poultry Report", style={"textAlign": "center", "font-weight": "bold"}),
            dbc.Row(
                [
                    dbc.Col(
                        [
...
def Poultry(PperiodClick, dummy, data, settings):
    ...
    figgPR, figgPSick, figgPDead = ReportsSickDead.ReportsSickDead(
        reportsdata, DateRange, PperiodClick, figheight, "Poultry"
    )

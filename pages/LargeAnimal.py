...
def LargeAnimal(LAperiodClick, dummy, data, geodata, settings):
    ...
    SelectedDistrict = (json.loads(settings))["district"]
    SelectedUpazila = (json.loads(settings))["upazila"]
    SelectedDisease = (json.loads(settings))["disease"]

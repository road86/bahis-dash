                    ...
                    dbc.Row([
                        dbc.Tabs([
                            dbc.Tab([
                                ...
                                label='Completeness', tab_id='CompletenessTab'),
                            dbc.Tab([
...
def update_whatever(geoTile, clkRep, clkSick, clkDead, SelDiv, SelDis, SelUpa, start_date, end_date, diseaselist, tabs, Completeness, geoSlider):
...
###tab0
    ...
    if tabs == 'CompletenessTab':
        ...
        return SelDiv, SelDis, SelUpa, vDiv, vDis, vUpa, ddDList, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, geoSlider, a
...
###tab1
    ...
    if tabs == 'ReportsTab':
        ...
        return SelDiv, SelDis, SelUpa, vDiv, vDis, vUpa, ddDList, figgR, figgSick, figgDead, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, geoSlider, no_update
...
####tab2
    ...
    if tabs == 'DiseaseTab':
        ...
        return SelDiv, SelDis, SelUpa, vDiv, vDis, vUpa, ddDList, no_update,  no_update, no_update, figgLiveS, figgZoon, no_update, no_update, no_update, no_update, no_update, no_update, no_update, geoSlider, no_update
...
### tab3 geolocation
    ...
    if tabs == 'GeoRepTab':
        ...
        return SelDiv, SelDis, SelUpa, vDiv, vDis, vUpa, ddDList, no_update, no_update, no_update, no_update, no_update, Rfindic, Rfigg, NRlabel, AlertTable, no_update, no_update, no_update, geoSlider, no_update
...
### tab 5 monthly currently not geo resolved and disease, because of bahis_data, either ata is time restricted or
    ...
    if tabs == 'MonthCompTab':
        ...
        return SelDiv, SelDis, SelUpa, vDiv, vDis, vUpa, ddDList, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, figMonthly, no_update, no_update, geoSlider, no_update
...
### tab 6 export tab
    ...
    #                                fixed_rows={'headers': True},
        ...
        return SelDiv, SelDis, SelUpa, vDiv, vDis, vUpa, ddDList, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, no_update, ExportLabel, ExportTab, geoSlider, no_update

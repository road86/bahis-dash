...
def get_pathnames(sourcepath):
    ...
    farmdatafilename = glob.glob(sourcepath + "newbahis_farm_assessment_logger*.csv")[-1]

    AIinvestdatafilename = glob.glob(sourcepath + "newbahis_bahis_avian_influenza_investigate_p2_table*.csv")[-1]
    DiseaseInvestdatafilename = glob.glob(sourcepath + "newbahis_bahis_disease_investigation_p2_table*.csv")[-1]
    PartLSAssdatafilename = glob.glob(sourcepath + "newbahis_bahis_participatory_livestock_assessment_table*.csv")[-1]
    medfilename = glob.glob(sourcepath + "newbahis_bahis_medicine_table*.csv")[-1]
